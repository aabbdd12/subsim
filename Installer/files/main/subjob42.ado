...
if (`gvimp'==1) {;
cap drop _imp_wel_``i'' ;
qui gen  _imp_wel_``i''  = __imwsub ;
lab var  _imp_wel_``i''   "Impact of the price change of item ``i'' on wellbeing";
};
...
lab var  _imp_on_well "Impact on per capita welfare" ;
};
