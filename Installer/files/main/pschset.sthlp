...
{p 0 4} {cmd:str:}    To indicate the price schedule structure. By default the we have the increasing block tariff structure. Set the value of this option to 2 to indicate that we have a volume differentiated tariff structure.{p_end}
