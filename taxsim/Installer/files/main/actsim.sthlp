...
{* April 2017}{...}
{hline}
{hi:TAXSIM 1.0: TAX SIMulation Stata Toolkit (Taxes on Corporates reforms}{right:{bf:World Bank}}
help for {hi:actsim}{right:Dialog box:  {bf:{dialog actsim}}}
{hline}

{title:Impact of tax-corporate/firm reforms on household wellbeing} 

{title:Syntax}
{p 8 10}{cmd:actsim}  {it:varlist (min=1, max=1)}  {cmd:,} [ 
...
{title:Description}
{p 8 8} {cmd: actsim} module is belonging the package TAXSIM. The latter was conceived to automate the estimation  the results of the corporate income tax reforms on household well-being.  By default, the results are reported by quinitiles, but the user can indicate any other partition of population.  The following lists shows the produces tables and graphs:{p_end}
...
{p 0 4} {cmdab:adshock}   By default the imapct is that of the short term. Use the option adshock(2) for the long term. {p_end}
