...
#delimit;
capture program drop itjobgr2;
program define itjobgr2, eclass;
version 9.2;
...
qui gen `ini_tax' =(___suma/`hsize') / `1'  ;
...
cap drop ___suma;
by `hhid', sort : egen float ___suma = total(__inc_tax) ;
qui gen `f`j'_tax' =(___suma/`hsize') / `1'  ;
...
list `hhid' `1' `pcexp'  `hsize' `glist' in 1/200;
*/
tgropt 2 `lan' ;
